<%@ Page Language="C#" MasterPageFile="~/Counter.master" AutoEventWireup="true" CodeFile="OSCount.aspx.cs" Inherits="OSCount" Title="操作系统统计" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="font-size: 9pt; width: 508px">
        ...
        <tr>
            <td>
                操作系统累计：<asp:Label ID="labOS" runat="server" Text="Label"></asp:Label></td>
        </tr>
        <tr>
            <td>
                        ...
                        <table style="font-size: 9pt; width: 472px">
                            <tr>
                                <td align="left" style="width: 85px">
                                    <asp:Label ID="labOS" runat="server" Text='<%# Eval("OS") %>'></asp:Label></td>
